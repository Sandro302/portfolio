...
- **[🔧 Swagger UI + ReDoc (Комбо)](./docs/full.html)** — Обе в одном файле с вкладками
...
- **[📚 ReDoc](./docs/index.html)** — Только чтение
- **[🔧 Swagger UI](./docs/swagger.html)** — Только тестирование
