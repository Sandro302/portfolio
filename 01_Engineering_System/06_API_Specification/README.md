...
- **[📚 ReDoc](./docs/index.html)** — Красивый и современный обзор API
  - Лучше для чтения и понимания
  - Отличный дизайн
  - Клиентский поиск

- **[🔧 Swagger UI](./docs/swagger.html)** — Интерактивное тестирование
  - Try It Out - прямое тестирование эндпоинтов
  - Детальная информация о параметрах
  - Загрузка файлов для тестирования
